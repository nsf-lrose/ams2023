...
$lat_origin = 40.446362; # Latitude of reference frame at origin time
$lon_origin = -104.636871;  # Longitude of reference frame at origin time
$u = 1; # U storm motion (m/s)
$v = 1; # V storm motion (m/s)
$ymd = "20080702"; # YYYYMMDD of initial time
$hr = 23; # Initial hour of track
$min = 04; # Initial minute of track
$sec = 00; # Initial second of track
$duration = 600; # Duration of track in seconds
$origintime = 58; # Time when the frame is at the lat and lon origin in seconds from initial HMS
